...
| **🎨 Interfaz Moderna** | Diseño profesional con temática cyberpunk/tecnología |
...
<div align="center">
  <table>
    <tr>
      ...
      <td align="center"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" width="50"><br>JavaScript ES6+</td>
    </tr>
  </table>
</div>

- **HTML5 Semántico** - Estructura clara y accesible
- **CSS3** - Grid, Flexbox, animaciones y diseño responsive
- **JavaScript Vanilla** - Sin dependencias externas, lógica de cálculo VLSM
...
1. **Campo de IP Base** - Ingresa la dirección IPv4 inicial
2. **Panel de Redes** - Agrega redes con nombre y cantidad de hosts
3. **Botón de Cálculo** - Ejecuta el algoritmo VLSM
4. **Tabla de Resultados** - Muestra todas las subredes calculadas
...
├── assets/
│ ├── img/
│ │ ├── fondo.png # Fondo principal
│ │ ├── fondo2.png # Fondo secundario
│ │ ├── logo.png # Logo del sitio
│ │ ├── subredes.png # Icono de subredes
│ │ └── footer/
│ │ ├── personaje1.png
│ │ ├── personaje2.png
│ │ ├── personaje3.png
...
│
├── js/
│ └── script.js # Lógica de cálculo VLSM
│
...
Ingresar IP Base - Ejemplo: 192.168.1.0

Agregar Redes - Especifica nombre y cantidad de hosts

Calcular - Presiona el botón "CALCULAR SUBNETEO VLSM"

Analizar Resultados - Revisa la tabla generada y el proceso binario

📚 Documentación
<div align="center"> <table> <tr> <td><img src="https://github.com/user-attachments/assets/4b218f48-f7a5-4476-b943-e1eaec24d09f" width="100%"></td> <td><img src="https://github.com/user-attachments/assets/af40f0a8-b810-4d0b-b4da-050e07d14841" width="100%"></td> </tr> </table> </div><div align="center"> <img src="https://github.com/user-attachments/assets/5ad585c1-885b-489f-b748-1e08f8c8156f" alt="Documentación" width="80%"> </div>
...
Canales de Contacto
Canal	Contacto
📧 Email	soporte@subneteo.com
🐙 GitHub	github.com/subneteo-vlsm
...
<div align="center"> <p> <strong>ネットワークとデータ通信 — サブネット計算プロフェッショナルツール</strong> </p> <p> <a href="mailto:soporte@subneteo.com">📧 soporte@subneteo.com</a> </p> </div>
📄 Licencia
Este proyecto está bajo la licencia MIT. Esto significa que puedes:

✅ Usar el software con fines comerciales y privados

✅ Modificar el código fuente

✅ Distribuir copias del software

✅ Incluir el software en productos comerciales

Solo se requiere mantener el aviso de copyright original.

<div align="center"> <p> <sub> Subneteo VLSM - Demostración didáctica | Conversión binaria y cálculo automático de saltos </sub> </p> <p> <sub>© 2024 Subneteo VLSM | MIT
